...
**EditorConfig.md** : The open source embeddable online markdown editor (component), based on CodeMirror & jQuery & Marked.
...
**EditorConfig.md** 是一款开源的、可嵌入的 Markdown 在线编辑器（组件），基于 CodeMirror、jQuery 和 Marked 构建。
...
<div id="editor">
    <!-- Tips: EditorConfig.md can auto append a `<textarea>` tag -->
    <textarea style="display:none;">### Hello EditorConfig.md !</textarea>
</div>
...
Sorry, EditorConfig.md not support HTML to Markdown parsing, Maybe In the future.
...
EditorConfig.md options and default values:
...
```javascript
{
    ...
    theme                : "",             // EditorConfig.md self themes, before v1.5.0 is CodeMirror theme, default empty
    editorTheme          : "default",      // EditorConfig area, this is CodeMirror theme at v1.5.0
    ...
    fontSize             : "13px",
    saveHTMLToTextarea   : false,          // If enable, EditorConfig will create a <textarea name="{editor-id}-html-code"> tag save HTML code for form post to server-side.
    disabledKeyMaps      : [],
    ...
    emoji                : false,          // :emoji: , Support Github emoji, Twitter Emoji (Twemoji);
                                           ...
                                           // Support EditorConfig.md logo icon emoji :editormd-logo: :editormd-logo-1x: > 1~8x;
