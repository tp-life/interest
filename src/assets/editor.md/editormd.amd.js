...
;(function(factory) {
    ...
    editormd.title        = editormd.$name = "EditorConfig.md";
    ...
    editormd.prototype    = editormd.fn = {
        ...
        /**
         * 设置 EditorConfig.md 的整体主题，主要是工具栏
         * Setting EditorConfig.md theme
         *
         * @returns {editormd}  返回editormd的实例对象
         */
         ...
         * Setting CodeMirror (EditorConfig area) theme
         *
         * @returns {editormd}  返回editormd的实例对象
         */
        ...
        /**
         * 创建关于Editor.md的对话框
         * Create about EditorConfig.md dialog
         *
         * @returns {editormd}  返回editormd的实例对象
         */
        ...
        /**
         * 关于Editor.md对话居中定位
         * EditorConfig.md dialog position handle
         *
         * @returns {editormd}  返回editormd的实例对象
         */
        ...
        /**
         * 显示关于Editor.md
         * Display about EditorConfig.md dialog
         *
         * @returns {editormd}  返回editormd的实例对象
         */
        ...
        /**
         * 隐藏关于Editor.md
         * Hide about EditorConfig.md dialog
         *
         * @returns {editormd}  返回editormd的实例对象
         */
        ...
        /**
         * 获取编辑器的markdown源文档
         * Set EditorConfig.md markdown/CodeMirror value
         *
         * @returns {editormd}         返回editormd的实例对象
         */
    ...
    editormd.markedRenderer = function(markdownToC, options) {
        var defaults = {
            ...
            taskList             : false,          // Enable Github Flavored Markdown task lists
            emoji                : false,          // :emoji: , Support Twemoji, fontAwesome, EditorConfig.md logo emojis.
            tex                  : false,          // TeX(LaTeX), based on KaTeX
            flowChart            : false,          // flowChart.js only support IE9+
            sequenceDiagram      : false,          // sequenceDiagram.js only support IE9+
        };
                    ...
                    else
                    {
                        ...
                        if (emdlogoMathcs)
                        {
                            for (var x = 0, len2 = emdlogoMathcs.length; x < len2; x++)
                            {
                                ...
                                return "<i class=\"" + logoName + "\" title=\"EditorConfig.md logo (" + logoName + ")\"></i>";
                            }
                        }
    ...
    // EditorConfig.md themes, change toolbar themes etc.
    // added @1.5.0
