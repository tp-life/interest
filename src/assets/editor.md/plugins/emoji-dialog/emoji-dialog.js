/*!
 * Emoji dialog plugin for EditorConfig.md
 *
...
(function() {
	...
	var factory = function (exports) {
		...
		exports.fn.emojiDialog = function() {
			...
			var category = ["Github emoji", "Twemoji", "Font awesome", "EditorConfig.md logo"];
                    ...
                    for (var i = 0; i < pageTotal; i++)
                    {
                        ...
                        for (var x = 0; x < rowNumber; x++)
                        {
                            ...
                            if (typeof emoji !== "undefined" && emoji !== "")
                            {
                                ...
                                {
                                    icon = "<i class=\"" + emoji + "\" title=\"EditorConfig.md logo (" + emoji + ")\"></i>";
